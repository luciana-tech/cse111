#Exceeding requirements:constants defined
...
def pressure_loss_from_fittings(
    ...
    """ This function calculates the water pressure lost because of fittings such as 45° and 90° bends that are
...
def reynolds_number(hydraulic_diameter, fluid_velocity):
    ...
    """
    reynolds_number_value = (WATER_DENSITY*hydraulic_diameter*fluid_velocity)/WATER_DYNAMIC_VISCOSITY
...
def pressure_loss_from_pipe_reduction(larger_diameter,
    ...
    pressure_lost_from_reduction = (-k*WATER_DENSITY*pow(fluid_velocity,2))/2000
    
    return pressure_lost_from_reduction
